...
public class Queen extends Piece {
    ...
    {
    	// Movement restrictions for Queen
    	...
    	if (direction.equals("north")) // check if there is a piece in south
    	{
    		int move_piece = Math.abs(destination_y - this.getY());
    		for (int i = 1; i < move_piece; i++)
    		{
    	...
    	if (direction.equals("east")) // check if there is a piece in south
    	{
    	...
    	if (direction.equals("west")) // check if there is a piece in south
    	{
    		int move_piece = Math.abs(destination_x - this.getX());
    		for (int i = 1; i < move_piece; i++)
    		{
